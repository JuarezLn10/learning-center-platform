...
public class ProgressRecord {
    ...
    public void startTutorial(TutorialId tutorialId) {
        ...
        if (progressRecordItem.isInProgressOrCompleted()) throw new IllegalStateException("The tutorial with id " + tutorialId.toString() + " is already in progress.");
    ...
    public void completeTutorial(TutorialId tutorialId, LearningPath learningPath) {
        ...
        if (!progressRecordItem.isInProgress()) throw new IllegalStateException("The tutorial with id " + tutorialId.toString() + " is not in progress.");
